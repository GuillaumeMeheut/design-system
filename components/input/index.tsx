...
export const AppInput = ({ label, labelColor, id, password, color, fonts, size }: Props) => {
    ...
    return (
        <div>
            ...
            <div className={css.inputContainer}>
                <input id={id} type={visible ? "text" : 'password'} style={{ ...fonts, ...color, ...size }} className={css.input} />
